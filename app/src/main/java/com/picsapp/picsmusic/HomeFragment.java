...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = view.findViewById(R.id.rv_song_list1);
        ...
        // set up the RecyclerView
        RecyclerView recyclerView2 = view.findViewById(R.id.rv_song_list2);
        ...
        SongItemMainAdapter adapter2 = new SongItemMainAdapter(getActivity(), songListDetails2);
        ...
        // set up the RecyclerView
        RecyclerView recyclerView3 = view.findViewById(R.id.rv_song_list3);
        ...
        SongItemMainAdapter adapter3 = new SongItemMainAdapter(getActivity(), songListDetails3);
        ...
        // set up the RecyclerView
        RecyclerView recyclerView4 = view.findViewById(R.id.rv_song_list4);
        ...
        SongItemMainAdapter adapter4 = new SongItemMainAdapter(getActivity(), songListDetails4);
        ...
        // set up the RecyclerView
        RecyclerView recyclerView5 = view.findViewById(R.id.rv_song_list5);
        ...
        SongItemMainAdapter adapter5 = new SongItemMainAdapter(getActivity(), songListDetails5);
        ...
        // set up the RecyclerView
        RecyclerView recyclerView6 = view.findViewById(R.id.rv_song_list6);
        ...
        SongItemMainAdapter adapter6 = new SongItemMainAdapter(getActivity(), songListDetails6);
